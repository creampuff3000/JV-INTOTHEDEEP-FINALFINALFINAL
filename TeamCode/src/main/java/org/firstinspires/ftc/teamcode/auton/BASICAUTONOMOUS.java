...
//            specimen("high");
        ...
        if (Alliance == Parking.lRed) {
            ...
            while (robot.DistSensor.getDistance(DistanceUnit.CM) > 11){
            ...
            sleep(1000);
            robot.RslideMotor.setTargetPosition(robot.RslideMotor.getCurrentPosition() - 4000);
            robot.LslideMotor.setTargetPosition(robot.LslideMotor.getCurrentPosition() - 4000);
